...
and [<AllowNullLiteral>] PackageAPI =
    [<Emit("new $0($1...)")>] abstract Create: unit -> PackageAPI
    abstract addAssets: filenames: U2<string, ResizeArray<string>> * architecture: U2<string, ResizeArray<string>> -> unit
    abstract addFiles: filenames: U2<string, ResizeArray<string>> * ?architecture: U2<string, ResizeArray<string>> * ?options: obj -> unit
    abstract export: exportedObjects: U2<string, ResizeArray<string>> * ?architecture: U2<string, ResizeArray<string>> * ?exportOptions: obj * ?testOnly: bool -> unit
    abstract imply: packageNames: U2<string, ResizeArray<string>> * ?architecture: U2<string, ResizeArray<string>> -> unit
    abstract ``use``: packageNames: U2<string, ResizeArray<string>> * ?architecture: U2<string, ResizeArray<string>> * ?options: obj -> unit
    abstract versionsFrom: meteorRelease: U2<string, ResizeArray<string>> -> unit
...
module ``meteor/accounts-base`` =
    type [<AllowNullLiteral>] EmailFields =
        abstract from: Func<unit, string> option with get, set
        abstract subject: Func<Meteor.User, string> option with get, set
        abstract text: Func<Meteor.User, string, string> option with get, set
        abstract html: Func<Meteor.User, string, string> option with get, set
...
module App =
    type [<Import("*","App")>] Globals =
        static member accessRule(pattern: string, ?options: obj): unit = jsNative
        static member configurePlugin(id: string, config: obj): unit = jsNative
        static member icons(icons: obj): unit = jsNative
        static member info(options: obj): unit = jsNative
        static member launchScreens(launchScreens: obj): unit = jsNative
        static member setPreference(name: string, value: string, ?platform: string): unit = jsNative



module Assets =
    type [<Import("*","Assets")>] Globals =
        static member getBinary(assetPath: string, ?asyncCallback: Function): EJSON = jsNative
        static member getText(assetPath: string, ?asyncCallback: Function): string = jsNative
        static member absoluteFilePath(assetPath: string): string = jsNative



module Cordova =
    type [<Import("*","Cordova")>] Globals =
        static member depends(dependencies: obj): unit = jsNative



module Npm =
    type [<Import("*","Npm")>] Globals =
        static member depends(dependencies: obj): unit = jsNative
        static member require(name: string): obj = jsNative



module Package =
    type [<Import("*","Package")>] Globals =
        static member describe(options: obj): unit = jsNative
        static member onTest(func: Func<PackageAPI, unit>): unit = jsNative
        static member onUse(func: Func<PackageAPI, unit>): unit = jsNative
        static member registerBuildPlugin(?options: obj): unit = jsNative



module ``meteor/tools`` =
    type [<AllowNullLiteral>] PackageAPI =
        [<Emit("new $0($1...)")>] abstract Create: unit -> PackageAPI
        abstract addAssets: filenames: U2<string, ResizeArray<string>> * architecture: U2<string, ResizeArray<string>> -> unit
        abstract addFiles: filenames: U2<string, ResizeArray<string>> * ?architecture: U2<string, ResizeArray<string>> * ?options: obj -> unit
        abstract export: exportedObjects: U2<string, ResizeArray<string>> * ?architecture: U2<string, ResizeArray<string>> * ?exportOptions: obj * ?testOnly: bool -> unit
    ...
    type [<Import("*","meteor/tools")>] Globals =
        static member console with get(): Console = jsNative and set(v: Console): unit = jsNative
        static member execFileAsync(command: string, ?args: ResizeArray<obj>, ?options: obj): obj = jsNative
        static member execFileSync(command: string, ?args: ResizeArray<obj>, ?options: obj): string = jsNative

    module App =
        type [<Import("App","meteor/tools")>] Globals =
            static member accessRule(pattern: string, ?options: obj): unit = jsNative
            static member configurePlugin(id: string, config: obj): unit = jsNative
            static member icons(icons: obj): unit = jsNative
            static member info(options: obj): unit = jsNative
    ...
    module Assets =
        type [<Import("Assets","meteor/tools")>] Globals =
            static member getBinary(assetPath: string, ?asyncCallback: Function): EJSON = jsNative
            static member getText(assetPath: string, ?asyncCallback: Function): string = jsNative
            static member absoluteFilePath(assetPath: string): string = jsNative
    ...
    module Cordova =
        type [<Import("Cordova","meteor/tools")>] Globals =
            static member depends(dependencies: obj): unit = jsNative



    module Npm =
        type [<Import("Npm","meteor/tools")>] Globals =
            static member depends(dependencies: obj): unit = jsNative
            static member require(name: string): obj = jsNative
    ...
    module Package =
        type [<Import("Package","meteor/tools")>] Globals =
            static member describe(options: obj): unit = jsNative
            static member onTest(func: Func<PackageAPI, unit>): unit = jsNative
            static member onUse(func: Func<PackageAPI, unit>): unit = jsNative
            static member registerBuildPlugin(?options: obj): unit = jsNative
